    ...
    <html lang="en">
      ...
      <body className="min-h-screen bg-background font-sans antialiased">
        <div className="flex min-h-screen flex-col">
          <header className="sticky top-0 z-50 w-full border-b border-gold-dark/20 bg-content-bg">
            <div className="container mx-auto flex h-16 items-center px-4">
              <Link to="/" className="flex items-center gap-2.5">
                <div className="flex h-8 w-8 items-center justify-center rounded-lg bg-gold-dark/20">
                  <BookOpen className="h-4 w-4 text-gold-dark" />
                </div>
                <span className="font-serif text-lg font-medium tracking-tight text-gold-dark">
                  Ask the Librarian
                </span>
              </Link>
              <nav className="ml-auto flex items-center gap-1">
                <Link
                  to="/"
                  className="inline-flex items-center gap-2 rounded-lg px-4 py-2 text-sm font-medium text-content-fg/70 transition-colors hover:bg-gold-dark/10 hover:text-gold-dark [&.active]:bg-gold-dark/10 [&.active]:text-gold-dark"
                >
